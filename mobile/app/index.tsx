  ...
  return (
    <SafeAreaProvider>
      <SafeAreaView style={styles.container}>
        ...
        <Link href="/scene" asChild>
          <Pressable style={styles.button}>
            <Text style={styles.buttonText}>Open 3D Lab</Text>
          </Pressable>
        </Link>

        <Link href="/combat" asChild>
          <Pressable style={styles.button}>
            <Text style={styles.buttonText}>Open Hitbox Lab</Text>
          </Pressable>
        </Link>

        <Link href="/map" asChild>
          <Pressable style={styles.button}>
            <Text style={styles.buttonText}>Open Map Lab</Text>
          </Pressable>
        </Link>
